package com.sparta.foodorder.domain.user.entity;

import com.sparta.foodorder.domain.user.enums.UserRole;
import com.sparta.foodorder.domain.user.enums.UserStatus;
