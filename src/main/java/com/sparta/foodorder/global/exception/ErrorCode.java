...
public enum ErrorCode {
    ...
    // 온셥 관련 에러
    OPTION_PERMISSION_DENIED(HttpStatus.FORBIDDEN, "MO002", "해당 옵션에 대한 접근권한이 없습니다."),
    OPTION_NOT_FOUND(HttpStatus.NOT_FOUND, "MO003", "존재하지 않는 옵션입니다."),
    OPTION_VALUE_NOT_FOUND(HttpStatus.NOT_FOUND, "MO004", "존재하지 않는 옵션값입니다."),
